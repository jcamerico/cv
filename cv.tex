...
\begin{document}
	...
	\begin{resume}
		...
		\vspace{-2mm}
		\section{EXPERIENCE} 
			\textbf{Tech Lead} at {\sl Amundi Technology}, Paris, France \hfill Apr 2025 - present\\
                 	\begin{small}              
	                 	{\color{darkgray} Fullstack development in the Employee Savings and Retirement (ESR) department for the replacement of Siebel CRM.}\\
		                 {\color{gray} $\cdot$ Java, SpringBoot, Angular, Jenkins, Velocity, Antlr.}
        	         	\end{small}
						 \vspace{1mm}\\
			\textbf{Tech Lead} at {\sl TotalEnergies Digital Factory}, Paris, France \hfill Apr 2022 - Mar 2025\\
                 	\begin{small}              
	                 	{\color{darkgray} Led and coached development squads to build cloud-first applications to accelerate and digitalize TotalEnergies processes. Wrote technical documentation, coached developers, established technical roadmaps and offered support to product owners.}\\
