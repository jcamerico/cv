	...
	\begin{resume}
		...
		\section{EXPERIENCE} 
			\textbf{Tech Lead} at {\sl Amundi Technology}, Paris, France \hfill Apr 2025 - present\\
                 	\begin{small}              
	                 	{\color{darkgray} Fullstack development for the replacement of Siebel CRM.}\\
			...
			\textbf{Tech Lead} at {\sl TotalEnergies Digital Factory}, Paris, France \hfill Apr 2022 - Mar 2025\\
                 	\begin{small}              
	                 	{\color{darkgray} Led squads to build cloud-first applications to digitalize legacy processes. Wrote technical documentation, established technical roadmaps and offered support to stakeholders.}\\
		...
		\section{COMPETENCES} {\sl Portuguese:} Native \hfill {\sl French:} Fluent (oral/written) \hfill {\sl English:} Fluent (oral/written)\\
			{\sl Programming Languages:} Java, Javascript/Typescript, Python\\
		\vspace{-6mm}
