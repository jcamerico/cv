...
\begin{document}
	...
	\vspace{-5mm}
	\begin{resume}
		\section{OBJECTIVE}  A position of Senior Software Engineer, Lead developer, Tech lead or Architect.
		\vspace{-2mm}
		\section{EXPERIENCE} 
			\textbf{Tech Lead} at {\sl TotalEnergies Digital Factory}, Paris, France \hfill Apr 2022 - present\\
                 	\begin{small}              
	                 	{\color{darkgray} Technical leading on MVPs to digitalize TotalEnergies processes.}\\
		                 {\color{gray}Azure, Java, Spring, Angular, Github Actions, Gradle, Gherkin, Playwright, Terraform.}
        	         	\end{small}
			\textbf{Senior Software Engineer} at {\sl Murex S.A.S.}, Paris, France \hfill Nov 2013 - Mar 2022\\
                 	\begin{small}              
		                 ...
		                 {\color{gray}Java, Maven, Camel, ActiveMQ, Spring, Jenkins, Cucumber, Git, SAFe.}
        	         	\end{small}
	              	\vspace{1mm}\\
